...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  Future<void> fetchNotifications() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.1.12:8080/api/notifications'));
  ...
  Future<void> sendNotification() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://1192.168.1.12:8080/api/notifications'),
  ...
  Future<void> deleteNotification(String id) async {
    try {
      final response = await http.delete(Uri.parse('http://192.168.1.12:8080/api/notifications/$id'));
      if (response.statusCode == 200) {
        ScaffoldMessenger.of(context)
